					...
					<div class="board">
						...
						<c:if test="${!empty tradeList }">
							<c:forEach var="tradeItem" items="${tradeList}">
								<div class="con1">
									<a href="tradeDetail?trade_NO=${tradeItem.trade_NO }"> 
									<img src="/resources/uploadThumbnail/${tradeItem.img_CHNG_NM}"	alt="사진"></a>
									<p> 
			                                	 <fmt:formatDate var="productDate" pattern="yyyy-MM-dd HH:MM" value="${tradeItem.product_DATE }" />
