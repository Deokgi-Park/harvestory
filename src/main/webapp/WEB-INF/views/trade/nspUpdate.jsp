...
<style>
    ...
    $(document).ready(function() {
        ...
        $(".originImgDeleteBtn").click(function(){
        	
        	const btn = $(this);
        	const img_NO = btn.prev().val();
                ...
                <section>
                    <article>
                        ...
                        <div class="board">
				            ...
				            <c:if test="${nspDetailImages != null}">
				    			<div>
				    			<br><h4>기존 이미지 삭제</h4>
				    				<table border="1">
				    					<c:forEach var="nsp" items="${nspDetailImages}">
					    					 <tr style="float:left; margin-right:1.5em;">
				                        		<td style="inline-block" class="originImgTd">
						                        	<img src="/resources/uploadThumbnail/${nsp.img_CHNG_NM}" height="100px" width="100px">
						                        	<input type="hidden" class="deleteImgNO" value="${nsp.img_NO}">
						                        	<input type="button" class="originImgDeleteBtn" value="X">
				                        		</td>
				                        	</tr>
                                	</c:forEach> 
			                        </table>
						...
						<form method="post" enctype="multipart/form-data" id="uploadForm" action="nspUpdate">
							<input type="text" name="product_TITLE" placeholder="제목" value="${nspDetailItem.product_TITLE }">
							<input type="text" name="product_PRICE" placeholder="가격" value="${nspDetailItem.product_PRICE }">
							<input type="hidden" name="user_ID" value="${nspDetailItem.user_ID }">
							<input type="hidden" name="trade_NO" placeholder="" value="${nspDetailItem.trade_NO }">
							
							<br><br><h4>신규 이미지 등록</h4>
							...
							<textarea id="summernote" name="product_CONTENT">${nspDetailItem.product_CONTENT }</textarea>
							<script>
